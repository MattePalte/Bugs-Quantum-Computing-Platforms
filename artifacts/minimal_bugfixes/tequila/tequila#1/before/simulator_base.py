...
class BackendCircuit():
    ...
    @@ -88,6 +88,9 @@ def __init__(self, abstract_circuit: QCircuit, variables, noise=None,
    ...
    @@ -124,6 +127,16 @@ def create_circuit(self, abstract_circuit: QCircuit, *args, **kwargs):
    ...
    @@ -312,8 +325,8 @@ def extract_variables(self) -> typing.Dict[str, numbers.Real]:
...
class BackendExpectationValue:
    ...
    @@ -348,8 +361,8 @@ def __call__(self, variables, samples: int = None, *args, **kwargs):
